      ...
      <Form onSubmit={handleSubmit(onSubmit)}>
        <Form.Group className="mb-3">
          ...
          <Form.Control
            ...
            {...register("nome", {
              ...
              maxLength: { value: 150, message: "Limite de 130 caracteres." },
            })}
          />
          {errors.nome && (
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control
            ...
            {...register("preco", {
              ...
              max: {
                value: 99999,
                message: "Preço deve ser menor ou igual a 99999.",
              },
            })}
          />
          {errors.preco && (
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control
            ...
            {...register("desconto", {
              ...
              min: {
                value: 0,
                message: "Desconto deve ser maior ou igual a 0.",
              },
              max: {
                value: 99999,
                message: "Desconto deve ser menor ou igual a 99999.",
              },
            })}
          />
          {errors.desconto && (
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Control
            ...
            {...register("dataDesconto", { required: "A data é obrigatória" })}
          />
