...
export function EditaCliente() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:3001/clientes/${id}`)
            .then(response => {
                ...
                reset({ nome, email, telefone, endereco: { cidade, cep, uf, rua, numero } });
            })
    }, [id, reset])
    ...
    useEffect(() => {
      ...
      useEffect(() => {
       ...
       function handleEstadoMudança(event) {
      ...
      function handleCidadeMudança(event) {
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select
                ...
                onChange={handleEstadoMudança}
                value={estadoSelecionado}
              >
                <option value="">Selecione a UF</option>
    
                {estados.sort((a, b) => (a.nome > b.nome) ? 1 : -1).map((estado) => (
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Select
                ...
                onChange={handleCidadeMudança}
                value={cidadeSelecionada}
              >
                <option>Selecione uma cidade</option>
    
                {cidades.sort((a, b) => (a.nome > b.nome) ? 1 : -1).map((cidade) => (
